...
dataspace1d(0.06, 10.0, 0.025, id="faked")
#plot_source("faked")

from sherpa_contrib.utils import *
save_instmap_weights("faked", "./spectrum/spectrum_erg.txt", fluxtype="erg")
save_instmap_weights("faked", "./spectrum/spectrum_ph.txt")
