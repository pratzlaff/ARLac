...
;and modified to match the AR Lac system rather than YY Gem (VK; 99X)
;-
...
if or1 ne r1 or oh1 ne h1 or om1 ne m1 or om2 ne m2 then $
  img1=sphervol(r1,r1+h1,drad=drad,v=visual,xrange=xra,yrange=yra,nx=nx,ny=ny)
if or2 ne r2 or oh2 ne h2 or om1 ne m1 or om2 ne m2 then $
...
for i=0,nt-1 do begin
  ...
  tvscl,2*front+back
  print,nx/2-ix1,ny/2-iy1,nx/2-ix2,ny/2-iy2
